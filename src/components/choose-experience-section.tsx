    ...
    <div className="relative w-full min-h-screen flex flex-col px-8 md:px-16 pt-12 pb-20 bg-black">
      ...
      <div className="flex items-center justify-between flex-1 gap-8">
        ...
        >
          ...
          >
            Choose how you want to connect and experience Harborleaf. From social networking to messaging, we have the perfect way for you to engage.
          </motion.p>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.7 }}>
            ...
            <ul className="space-y-2 text-white/90 text-base">
              <li className="flex items-start">
                ...
                <span>
                  <strong>Social Media</strong> - Share posts, discover people, and build real connections.
                </span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>
                  <strong>Messaging</strong> - Chat privately and securely with verified users.
                </span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>
                  <strong>SOS Alert</strong> - Emergency assistance at one tap when you need it most.
                </span>
              </li>
            </ul>
          </motion.div>
