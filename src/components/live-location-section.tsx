    ...
    <div className="relative w-full min-h-[calc(100vh-40px)] flex flex-col px-8 md:px-16 pt-12 pb-20 bg-black">
      ...
      <div className="flex items-center justify-between flex-1 gap-8">
        ...
        >
          ...
          >
            Live Location Tracking - Real-time location sharing with verified helpers and emergency responders.
          </motion.p>

          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.7 }}>
            <h3 className="text-white text-xl font-bold mb-3">You Can See:</h3>
            <ul className="space-y-2 text-white/90 text-base">
              <li className="flex items-start">
                <span className="mr-2">👤</span>
                <span>
                  <strong>Who Received Your Alert</strong> - View all verified users who got your SOS notification.
                </span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">🚗</span>
                <span>
                  <strong>Who is on the Way</strong> - Track helpers and responders heading to your location in real-time.
                </span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">📍</span>
                <span>
                  <strong>Your Exact Live Location</strong> - Continuous location updates to ensure accurate assistance.
                </span>
              </li>
              <li className="flex items-start mt-4">
                <span className="mr-2">🛡️</span>
                <span>
                  <strong>Updates in Real-Time</strong> - Never lose connection with your support network.
                </span>
              </li>
            </ul>
          </motion.div>
          ...
          >
            <div className="relative w-[220px] h-[440px] bg-black rounded-[40px] border-4 border-gray-700 shadow-2xl overflow-hidden">
              <div className="absolute inset-2 bg-gradient-to-br from-blue-900 to-black rounded-[32px] flex items-center justify-center">
                <img src="/images/phone-screen-1.jpg" alt="Live location map screen" className="absolute inset-0 w-full h-full object-cover rounded-[32px]" />
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative w-[200px] h-[400px] bg-black rounded-[40px] border-4 border-gray-700 shadow-2xl overflow-hidden opacity-80">
              <div className="absolute inset-2 bg-gradient-to-br from-blue-900 to-black rounded-[32px]">
                <img src="/images/phone-screen-2.jpg" alt="Alert recipients screen" className="absolute inset-0 w-full h-full object-cover rounded-[32px]" />
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative w-[180px] h-[360px] bg-black rounded-[40px] border-4 border-gray-700 shadow-2xl overflow-hidden opacity-70">
              <div className="absolute inset-2 bg-gradient-to-br from-green-900 to-black rounded-[32px]">
                <img src="/images/phone-screen-3.jpg" alt="Responders en route screen" className="absolute inset-0 w-full h-full object-cover rounded-[32px]" />
              </div>
            </div>
          </motion.div>
        </div>
