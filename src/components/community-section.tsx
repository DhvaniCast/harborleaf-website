    ...
    <div className="relative w-full min-h-screen flex flex-col px-8 md:px-16 pt-12 pb-20 bg-black">
      ...
      <div className="flex items-center justify-between flex-1 gap-8">
        ...
        >
          ...
          >
            How to Sign In to Harborleaf and access your verified network instantly. Get started with just your mobile number and password.
          </motion.p>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.7 }}>
            ...
            <ul className="space-y-2 text-white/90 text-base">
              <li className="flex items-start">
                ...
                <span>
                  <strong>1. Enter your mobile number</strong> registered with Harborleaf.
                </span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>
                  <strong>2. Type the password</strong> you created during sign-up.
                </span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>
                  <strong>3. Tap Sign In</strong> to access your account instantly.
                </span>
              </li>
              <li className="flex items-start mt-4">
                <span className="mr-2">💡</span>
                <span>
                  <strong>Forgot your password?</strong> Click 'Forgot Password' to reset it in seconds and regain access securely.
                </span>
              </li>
            </ul>
          </motion.div>
