...
export default function VerifiedBusinessSection() {
    ...
    <div className="relative w-full min-h-[calc(100vh-40px)] flex flex-col px-8 md:px-16 pt-12 pb-20 bg-black">
      ...
      <div className="flex items-center justify-between flex-1 gap-8">
        ...
        >
          ...
          >
            Verified Businesses & Sellers - Support local entrepreneurs with complete transparency and trust.
          </motion.p>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.7 }}>
            ...
            <ul className="space-y-2 text-white/90 text-base">
              <li className="flex items-start">
                ...
                <span>
                  <strong>Verified Business Listings</strong> - Browse authenticated local businesses and sellers.
                </span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>
                  <strong>Complete Transparency</strong> - View verified credentials, ratings, and customer reviews.
                </span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span>
                  <strong>Support Local SMEs</strong> - Direct connection to entrepreneurs and small business owners.
                </span>
              </li>
              <li className="flex items-start mt-4">
                <span className="mr-2">💼</span>
                <span>
                  <strong>Safe Transactions</strong> - Verified payment and dispute resolution for buyer protection.
                </span>
              </li>
            </ul>
          </motion.div>
          ...
          >
            <div className="relative w-[220px] h-[440px] bg-black rounded-[40px] border-4 border-gray-700 shadow-2xl overflow-hidden">
              <div className="absolute inset-2 bg-gradient-to-br from-blue-900 to-black rounded-[32px] flex items-center justify-center">
                <img src="/images/phone-screen-1.jpg" alt="Verified business listings screen" className="absolute inset-0 w-full h-full object-cover rounded-[32px]" />
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative w-[200px] h-[400px] bg-black rounded-[40px] border-4 border-gray-700 shadow-2xl overflow-hidden opacity-80">
              <div className="absolute inset-2 bg-gradient-to-br from-blue-900 to-black rounded-[32px]">
                <img src="/images/phone-screen-2.jpg" alt="Business profile screen" className="absolute inset-0 w-full h-full object-cover rounded-[32px]" />
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative w-[180px] h-[360px] bg-black rounded-[40px] border-4 border-gray-700 shadow-2xl overflow-hidden opacity-70">
              <div className="absolute inset-2 bg-gradient-to-br from-green-900 to-black rounded-[32px]">
                <img src="/images/phone-screen-3.jpg" alt="Reviews and ratings screen" className="absolute inset-0 w-full h-full object-cover rounded-[32px]" />
              </div>
            </div>
          </motion.div>
        </div>
